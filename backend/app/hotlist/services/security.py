...
移植自 TrendRadar (https://github.com/sansan0/TrendRadar) crawler/fetcher.py::_check_domain_safety，
改动：
...
def check_domain_safety(entries: list[RawEntry], expected_domain: str) -> str | None:
